...
-(void)viewDidLoad{
    ...
    if(self.meetData.MissedEntry==YES)
    {
        ...
        [self.vwTitle setText:[NSString stringWithFormat:@"%@",NSLocalizedString(@"Missed Entry - Other Work", "Missed Entry - Other Work")]];
    }
...
-(void)viewDidDisappear:(BOOL)animated{
    EditDateSelectionCtrl* EtCtrlr=(EditDateSelectionCtrl*)[self parentViewController];
    [EtCtrlr reloadDates];
}
