...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [WBService SendServerRequest:@"GET/DrDets" withParameter:[@{@"CusCode":self.CustCode,@"typ":_SelType} mutableCopy] withImages:nil DataSF:nil
        ...
        else if([_SelType isEqualToString:@"H"])
        {
            ...
            lblClass.text=NSLocalizedString(@"Class / Category", @"Class / Category");
            ...
            _lblCPerson.text=NSLocalizedString(@"Contact Person", @"Contact Person");
...
- (void)didClick:(id)Control{
    ...
    _lblSelHead.text=[NSString stringWithFormat:@"%@ %@",NSLocalizedString(@"Select the", @"Select the"),_eCtrl.Caption];
    _lblSelHead1.text=[NSString stringWithFormat:@"%@ %@",NSLocalizedString(@"Select the", @"Select the"),_eCtrl.Caption];
    _selectedText=@"";
    _selectedValue=@"";
